...
/**
 * BlockDeviceMappingType変換クラス。<br />
 * このクラスはレスポンスXMLのblockDeviceMapping要素からBlockDeviceMappingクラスのリストを生成します。
 */
public class BlockDeviceMappingConverter implements Converter {
	...
	/**
	 * {@literal
	 * blockDeviceMapping要素をList<BlockDeviceMapping>クラスに変換します。}
	 *
	 * @param reader XML読込リーダ
	 * @param context
	 * @return {@literal List<BlockDeviceMapping>オブジェクト}
	 *
	...
	public Object unmarshal(HierarchicalStreamReader reader, UnmarshallingContext context) {
		...
		Converter converter = new EbsBlockDeviceConverter();
		String name = null;
