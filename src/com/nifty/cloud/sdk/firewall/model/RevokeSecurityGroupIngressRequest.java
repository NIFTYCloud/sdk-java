...
/**
 * RevokeSecurityGroupIngressリクエストクラス。<br />
 * このクラスはRevokeSecurityGroupIngressへのリクエストを構築します。
 */
@Action("RevokeSecurityGroupIngress")
public class RevokeSecurityGroupIngressRequest implements Request {
	...
	/**
	 * ファイアウォールグループ名, 許可ルール情報リストを指定し、RevokeSecurityGroupIngressRequestを構築します。
