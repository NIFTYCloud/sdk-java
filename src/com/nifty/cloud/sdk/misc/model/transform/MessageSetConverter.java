...
/**
 *  XXXMessageSetType変換クラス。<br />
 *  このクラスはレスポンスXMLのmessageSet要素からStringクラスを生成するクラスの抽象クラスです。
 */
public abstract class MessageSetConverter implements Converter {
