...
/**
 * RegisterInstancesWithLoadBalancerリクエストクラス。<br />
 * このクラスはRegisterInstancesWithLoadBalancerへのリクエストを構築します。
 */
@Action("RegisterInstancesWithLoadBalancer")
public class RegisterInstancesWithLoadBalancerRequest implements Request {
	...
	/**
	 * ロードバランサー名、待ち受けポート、宛先ポートを指定し、RegisterInstancesWithLoadBalancerRequestを構築します。
	 * 
	 * @param loadBalancerName ロードバランサー名
	 * @param loadBalancerPort 待ち受けポート
	 * @param instancePort 宛先ポート
	 */
	public RegisterInstancesWithLoadBalancerRequest(String loadBalancerName, Integer loadBalancerPort, Integer instancePort){
	 ...
	 * @return 自オブジェクト
	 */
	public RegisterInstancesWithLoadBalancerRequest withLoadBalancerPort(Integer loadBalancerPort) {
	 ...
	 * @return 自オブジェクト
	 */
	public RegisterInstancesWithLoadBalancerRequest withInstancePort(Integer instancePort) {
