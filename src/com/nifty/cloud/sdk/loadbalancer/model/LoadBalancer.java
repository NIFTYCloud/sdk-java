...
public class LoadBalancer {
	 ...
	 * @return ロードバランサー名
	 */
	@Query(name="member", reverseSequence=true)		
	 ...
	 * @return 待ち受けポート
	 */
	@Query(name="LoadBalancerPort", reverseSequence=true)		
	 ...
	 * @return 宛先ポート
	 */
	@Query(name="InstancePort", reverseSequence=true)		
