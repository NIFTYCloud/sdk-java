...
/**
 * DeregisterInstancesFromLoadBalancerリクエストクラス。<br />
 * このクラスはDeregisterInstancesFromLoadBalancerへのリクエストを構築します。
 */
@Action("DeregisterInstancesFromLoadBalancer")
public class DeregisterInstancesFromLoadBalancerRequest implements Request {
	/** ロードバランサー名 */
	...
	/**
	 * ロードバランサー名、待ち受けポート、宛先ポートを指定し、DeregisterInstancesFromLoadBalancerRequestを構築します。
	 * 
	 * @param loadBalancerName ロードバランサー名
	 * @param loadBalancerPort 待ち受けポート
	 * @param instancePort 宛先ポート
	 */
	public DeregisterInstancesFromLoadBalancerRequest(String loadBalancerName, Integer loadBalancerPort, Integer instancePort) {
	 ...
	 * @return 自オブジェクト
	 */
	public DeregisterInstancesFromLoadBalancerRequest withLoadBalancerPort(Integer loadBalancerPort) {
	 ...
	 * @return 自オブジェクト
	 */
	public DeregisterInstancesFromLoadBalancerRequest withInstancePort(Integer instancePort) {
	 ...
	 * @return サーバー情報リスト
	 */
	@Query(name="Instances.member", require=true)	
