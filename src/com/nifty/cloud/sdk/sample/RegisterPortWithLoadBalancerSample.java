...
/**
 * RegisterPortWithLoadBalancerサンプル
 *
 */
public class RegisterPortWithLoadBalancerSample {

    /**
     * RegisterPortWithLoadBalancerを実行するサンプルです。
    ...
    public static void main(String[] args) {
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、RegisterPortWithLoadBalancerを実行します。
         ***********************************************************************/
        RegisterPortWithLoadBalancerRequest request = new RegisterPortWithLoadBalancerRequest();
        ...
        invokeRegisterPortWithLoadBalancer(client, request);

    }

    /**
     * RegisterPortWithLoadBalancer 実行サンプル
     * 設定されたリクエストから RegisterPortWithLoadBalancer を実行し、実行結果を表示します。
     *
     * @param client  クライアント
     * @param request リクエスト
     */
    public static void invokeRegisterPortWithLoadBalancer(
            NiftyLoadBalancerClient client,
            RegisterPortWithLoadBalancerRequest request) {
        try {
            RegisterPortWithLoadBalancerResult result = client.registerPortWithLoadBalancer(request);

            out.println("RegisterPortWithLoadBalancer Action Response");
            out.println("=============================================================================");

            if (result.getListeners() != null) {
                List<Listener> listeners = result.getListeners();
