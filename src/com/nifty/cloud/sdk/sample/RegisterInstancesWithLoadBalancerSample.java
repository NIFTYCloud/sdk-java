...
/**
 * RegisterInstancesWithLoadBalancerサンプル
 *
 */
public class RegisterInstancesWithLoadBalancerSample {

    /**
     * RegisterInstancesWithLoadBalancerを実行するサンプルです。
    ...
    public static void main(String[] args) {
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、RegisterInstancesWithLoadBalancerを実行します。
         ***********************************************************************/
        ...
        invokeRegisterInstancesWithLoadBalancer(client, request);

    }

    /**
     * RegisterInstancesWithLoadBalancer 実行サンプル
     * 設定されたリクエストから RegisterInstancesWithLoadBalancer　を実行し、実行結果を表示します。
     *
     * @param client  クライアント
     * @param request リクエスト
     */
    public static void invokeRegisterInstancesWithLoadBalancer(
            NiftyLoadBalancerClient client,
            RegisterInstancesWithLoadBalancerRequest request) {
        try {
            RegisterInstancesWithLoadBalancerResult result = client
                    .registerInstancesWithLoadBalancer(request);

            out.println("RegisterInstancesWithLoadBalancer Action Response");
            out.println("=============================================================================");
