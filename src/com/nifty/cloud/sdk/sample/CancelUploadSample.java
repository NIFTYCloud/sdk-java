 ...
 * 
 */
public class CancelUploadSample {
	/**
	 * CancelUploadを実行するサンプルです。 必要なパラメーターを設定してから利用してください。
	 * 
	 * @param args 利用しない
	 */
	public static void main(String[] args) {
		...
		/************************************************************************
		 * クライアント設定情報インスタンスを生成します。 設定情報を変更する場合は値を設定します。 以下の項目について設定可能です。 -
		 * ユーザーエージェント - プロトコル - プロキシサーバーアドレス - プロキシサーバーポート番号 - プロキシユーザー名 -
		 * プロキシパスワード - 最大リトライ回数 - 最大接続数 - TCPソケットタイムアウト秒数 - 接続タイムアウト秒数 -
		 * 送信バッファサイズ / 受信バッファサイズ - SignatureVersion - SignatureMethod HTTPメソッド
		 ***********************************************************************/
		...
		/************************************************************************
		 * リクエストパラメーターを設定し、CancelUploadを実行します。
		 ***********************************************************************/
		CancelUploadRequest request = new CancelUploadRequest();
		// request.setConversionTaskId("taskId");
		invokeCancelUpload(client, request);

	}

	/**
	 * CancelUpload 実行サンプル 設定されたリクエストから CancelUpload を実行し、実行結果を表示します。
	 * 
	 * @param client  クライアント
	 * @param request リクエスト
	 */
	public static void invokeCancelUpload(NiftyUploadClient client, CancelUploadRequest request) {
		try {
			CancelUploadResult result = client.cancelUpload(request);

			out.println("CancelUpload Action Response");
			out.println("=============================================================================");
