...
/**
 * RegisterInstancesWithSecurityGroupサンプル
 *
 */
public class RegisterInstancesWithSecurityGroupSample {

    /**
     * RegisterInstancesWithSecurityGroupを実行するサンプルです。
    ...
    public static void main(String[] args) {
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、RegisterInstancesWithSecurityGroupを実行します。
         ***********************************************************************/
        RegisterInstancesWithSecurityGroupRequest request = new RegisterInstancesWithSecurityGroupRequest();
        // request.setGroupName("groupName");
        // List<String> instanceIds = new ArrayList<String>();
        // instanceIds.add("instanceId");
        // request.setInstanceIds(instanceIds);

        invokeRegisterInstancesWithSecurityGroup(client, request);
    }

    /**
     * RegisterInstancesWithSecurityGroup 実行サンプル
     * 設定されたリクエストから RegisterInstancesWithSecurityGroupを実行し、実行結果を表示します。
     *
     * @param client   クライアント
     * @param request  リクエスト
     */
    public static void invokeRegisterInstancesWithSecurityGroup(
            NiftySecurityGroupClient client,
            RegisterInstancesWithSecurityGroupRequest request) {
        try {
            RegisterInstancesWithSecurityGroupResult result
                    = client.registerInstancesWithSecurityGroup(request);

            out.println("RegisterInstancesWithSecurityGroup Action Response");
            out.println("=============================================================================");
