...
/**
 * RevokeSecurityGroupIngressサンプル
 *
 */
public class RevokeSecurityGroupIngressSample {

    /**
     * RevokeSecurityGroupIngressを実行するサンプルです。
    ...
    public static void main(String[] args) {
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、RevokeSecurityGroupIngressを実行します。
         ***********************************************************************/
        ...
        invokeRevokeSecurityGroupIngress(client, request);
    }

    /**
     * RevokeSecurityGroupIngress 実行サンプル
     * 設定されたリクエストから RevokeSecurityGroupIngress を実行し、実行結果を表示します。
     *
     * @param client  クライアント
     * @param request リクエスト
     */
    public static void invokeRevokeSecurityGroupIngress(
            NiftySecurityGroupClient client,
            RevokeSecurityGroupIngressRequest request) {
        try {
            RevokeSecurityGroupIngressResult result = client.revokeSecurityGroupIngress(request);

            out.println("RevokeSecurityGroupIngress Action Response");
            out.println("=============================================================================");
