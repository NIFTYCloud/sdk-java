...
/**
 * SetFilterForLoadBalancerサンプル
 *
 */
public class SetFilterForLoadBalancerSample {

    /**
     * SetFilterForLoadBalancerを実行するサンプルです。
    ...
    public static void main(String[] args) {
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、SetFilterForLoadBalancerを実行します。
         ***********************************************************************/
        SetFilterForLoadBalancerRequest request = new SetFilterForLoadBalancerRequest();
        ...
        // ipAddress.setAddOnFilter(false);
        // ipAddresses.add(ipAddress);
        // request.setIpAddresses(ipAddresses);
        // request.setFilterType("filterType");

        invokeSetFilterForLoadBalancer(client, request);

    }

    /**
     * SetFilterForLoadBalancer 実行サンプル
     * 設定されたリクエストから SetFilterForLoadBalancer を実行し、実行結果を表示します。
     *
     * @param client  クライアント
     * @param request リクエスト
     */
    public static void invokeSetFilterForLoadBalancer(NiftyLoadBalancerClient client,
            SetFilterForLoadBalancerRequest request) {
        try {
            SetFilterForLoadBalancerResult result = client.setFilterForLoadBalancer(request);

            out.println("SetFilterForLoadBalancer Action Response");
            out.println("=============================================================================");
            if (result.getFilter() != null) {
                ...
                if(filter.getIpAddresses()!=null){
                    List<String> ipAddresses = filter.getIpAddresses();
