 ...
 *
 */
public class DeleteImageSample {

    /**
     * DeleteImageを実行するサンプルです。
    ...
    public static void main(String[] args) {
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、DeleteImageを実行します。
         ***********************************************************************/
        DeleteImageRequest request = new DeleteImageRequest();
        //request.setImageId("imageId");
        invokeDeleteImage(client, request);

    }

    /**
     * DeleteImage 実行サンプル
     * 設定されたリクエストから DeleteImage を実行し、実行結果を表示します。
     *
     * @param client   クライアント
     * @param request  リクエスト
     */
    public static void invokeDeleteImage(NiftyImageClient client,
            DeleteImageRequest request) {
        try {
            DeleteImageResult result = client.deleteImage(request);

            out.println("DeleteImage Action Response");
            out.println("=============================================================================");
