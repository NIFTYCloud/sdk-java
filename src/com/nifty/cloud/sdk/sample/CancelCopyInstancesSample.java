...
/**
 * CancelCopyInstancesサンプル
 *
 */
public class CancelCopyInstancesSample {
    /**
     * CancelCopyInstancesを実行するサンプルです。
    ...
    public static void main(String[] args) {
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、CancelCopyInstancesを実行します。
         ***********************************************************************/
        CancelCopyInstancesRequest request = new CancelCopyInstancesRequest();
        //request.setInstanceId("instanceId");
        invokeCancelCopyInstances(client, request);

    }

    /**
     * CancelCopyInstances 実行サンプル
     * 設定されたリクエストから CancelCopyInstances を実行し、実行結果を表示します。
     * @param client クライアント
     * @param request リクエスト
     */
    public static void invokeCancelCopyInstances(NiftyServerClient client, CancelCopyInstancesRequest request){
        try {
            CancelCopyInstancesResult result = client.cancelCopyInstances(request);

            out.println("CancelCopyInstances Action Response");
            out.println("=============================================================================");
