...
/**
 * NiftyModifyAddressAttributeサンプル
 *
 */
public class NiftyModifyAddressAttributeSample {

    /**
     * NiftyModifyAddressAttributeを実行するサンプルです。
    ...
    public static void main(String[] args) {
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、NiftyModifyAddressAttributeを実行します。
         ***********************************************************************/
         NiftyModifyAddressAttributeRequest request = new NiftyModifyAddressAttributeRequest();
         // request.setPublicIp("publicIp");
         // request.setPrivateIpAddress("privateIp");
         // request.setAttribute("description");
         // request.setValue("value");
        invokeNiftyModifyAddressAttribute(client, request);
    }

    /**
     * NiftyModifyAddressAttribute 実行サンプル
     * 設定されたリクエストから NiftyModifyAddressAttribute を実行し、実行結果を表示します。
     *
     * @param client   クライアント
     * @param request  リクエスト
     */
    public static void invokeNiftyModifyAddressAttribute(NiftyAddressClient client,
            NiftyModifyAddressAttributeRequest request) {
        try {
            NiftyModifyAddressAttributeResult result = client.niftyModifyAddressAttribute(request);

            out.println("NiftyModifyAddressAttribute Action Response");
            out.println("=============================================================================");
