...
/**
 * DownloadSslCertificateサンプル
 *
 */
public class DownloadSslCertificateSample {

    /**
     * DownloadSslCertificateを実行するサンプルです。
    ...
    public static void main(String[] args) {
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、DownloadSslCertificateを実行します。
         ***********************************************************************/
        DownloadSslCertificateRequest request = new DownloadSslCertificateRequest();
        // request.setFqdnId("fqdnId");
        // request.setFileType("fileType");

        invokeDownloadSslCertificate(client, request);
    }

    /**
     * DownloadSslCertificate 実行サンプル
     * 設定されたリクエストから DownloadSslCertificateを実行し、実行結果を表示します。
     *
     * @param client   クライアント
     * @param request  リクエスト
     */
    public static void invokeDownloadSslCertificate(
            NiftySslCertClient client, DownloadSslCertificateRequest request) {
        try {
            DownloadSslCertificateResult result = client.downloadSslCertificate(request);

            out.println("DownloadSslCertificate Action Response");
            out.println("=============================================================================");
            ...
            if (result.getFileData() != null) {
                out.println("  fileData  : " + result.getFileData());
            }
