...
/**
 * DeleteLoadBalancerサンプル
 *
 */
public class DeleteLoadBalancerSample {

    /**
     * DeleteLoadBalancerを実行するサンプルです。
    ...
    public static void main(String[] args) {
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、DeleteLoadBalancerを実行します。
         ***********************************************************************/
        ...
        invokeDeleteLoadBalancer(client, request);

    }

    /**
     * DeleteLoadBalancer 実行サンプル
     * 設定されたリクエストから DeleteLoadBalancer を実行し、実行結果を表示します。
     *
     * @param client   クライアント
     * @param request  リクエスト
     */
    public static void invokeDeleteLoadBalancer(NiftyLoadBalancerClient client,
            DeleteLoadBalancerRequest request) {
        try {
            DeleteLoadBalancerResult result = client.deleteLoadBalancer(request);

            out.println("DeleteLoadBalancer Action Response");
            out.println("=============================================================================");
