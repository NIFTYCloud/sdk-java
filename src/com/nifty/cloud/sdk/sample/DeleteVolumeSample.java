 ...
 *
 */
public class DeleteVolumeSample {

    /**
     * DeleteVolumeを実行するサンプルです。
    ...
    public static void main(String[] args) {
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、DeleteVolumeを実行します。
         ***********************************************************************/
        DeleteVolumeRequest request = new DeleteVolumeRequest();
        // request.setVolumeId("volumeId");
        invokeDeleteVolume(client, request);

    }

    /**
     * DeleteVolume 実行サンプル
     * 設定されたリクエストから DeleteVolume を実行し、実行結果を表示します。
     *
     * @param client   クライアント
     * @param request  リクエスト
     */
    public static void invokeDeleteVolume(NiftyDiskClient client,
            DeleteVolumeRequest request) {
        try {
            DeleteVolumeResult result = client.deleteVolume(request);

            out.println("DeleteVolume Action Response");
            out.println("=============================================================================");
