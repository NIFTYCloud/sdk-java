...
/**
 * CreateLoadBalancerサンプル
 *
 */
public class CreateLoadBalancerSample {

    /**
     * CreateLoadBalancerを実行するサンプルです。
    ...
    public static void main(String[] args) {
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、CreateLoadBalancerを実行します。
         ***********************************************************************/
        ...
        // request.setIpVersion("v6");
        // request.setAccountingType("accountingType");
        invokeCreateLoadBalancer(client, request);

    }

    /**
     * CreateLoadBalancer 実行サンプル
     * 設定されたリクエストから CreateLoadBalancer を実行し、実行結果を表示します。
     *
     * @param client  クライアント
     * @param request リクエスト
     */
    public static void invokeCreateLoadBalancer(NiftyLoadBalancerClient client,
            CreateLoadBalancerRequest request) {
        try {
            CreateLoadBalancerResult result = client.createLoadBalancer(request);

            out.println("CreateLoadBalancer Action Response");
            out.println("=============================================================================");
