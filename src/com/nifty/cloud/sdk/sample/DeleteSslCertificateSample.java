...
/**
 * DeleteSslCertificateサンプル
 *
 */
public class DeleteSslCertificateSample {

    /**
     * DeleteSslCertificateを実行するサンプルです。
    ...
    public static void main(String[] args) {
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、DeleteSslCertificateを実行します。
         ***********************************************************************/
        DeleteSslCertificateRequest request = new DeleteSslCertificateRequest();
        // request.setFqdnId("fqdnId");

        invokeDeleteSslCertificate(client, request);
    }

    /**
     * DeleteSslCertificate 実行サンプル
     * 設定されたリクエストから DeleteSslCertificateを実行し、実行結果を表示します。
     *
     * @param client   クライアント
     * @param request  リクエスト
     */
    public static void invokeDeleteSslCertificate(
            NiftySslCertClient client,
            DeleteSslCertificateRequest request) {
        try {
            DeleteSslCertificateResult result = client.deleteSslCertificate(request);

            out.println("DeleteSslCertificate Action Response");
            out.println("=============================================================================");
