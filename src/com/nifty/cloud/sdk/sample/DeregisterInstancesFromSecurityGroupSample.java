...
/**
 * DeregisterInstancesFromSecurityGroupサンプル
 *
 */
public class DeregisterInstancesFromSecurityGroupSample {

    /**
     * DeregisterInstancesFromSecurityGroupを実行するサンプルです。
    ...
    public static void main(String[] args) {
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、DeregisterInstancesFromSecurityGroupを実行します。
         ***********************************************************************/
        DeregisterInstancesFromSecurityGroupRequest request = new DeregisterInstancesFromSecurityGroupRequest();
        // request.setGroupName("groupName");
        // List<String> instanceIds = new ArrayList<String>();
        // instanceIds.add("instanceId");
        // request.setInstanceIds(instanceIds);

        invokeDeregisterInstancesFromSecurityGroup(client, request);
    }

    /**
     * DeregisterInstancesFromSecurityGroup 実行サンプル
     * 設定されたリクエストから DeregisterInstancesFromSecurityGroupを実行し、実行結果を表示します。
     *
     * @param client   クライアント
     * @param request  リクエスト
     */
    public static void invokeDeregisterInstancesFromSecurityGroup(
            NiftySecurityGroupClient client,
            DeregisterInstancesFromSecurityGroupRequest request) {
        try {
            DeregisterInstancesFromSecurityGroupResult result
                    = client.deregisterInstancesFromSecurityGroup(request);

            out.println("DeregisterInstancesFromSecurityGroup Action Response");
            out.println("=============================================================================");

            if (result.getInstanceIds() != null) {
