...
/**
 * DeregisterInstancesFromLoadBalancerサンプル
 *
 */
public class DeregisterInstancesFromLoadBalancerSample {

    /**
     * DeregisterInstancesFromLoadBalancerを実行するサンプルです。
    ...
    public static void main(String[] args) {
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、DeregisterInstancesFromLoadBalancerを実行します。
         ***********************************************************************/
        ...
        invokeDeregisterInstancesFromLoadBalancer(client, request);
    }

    /**
     * DeregisterInstancesFromLoadBalancer 実行サンプル
     * 設定されたリクエストからDeregisterInstancesFromLoadBalancer を実行し、実行結果を表示します。
     *
     * @param client クライアント
     * @param request リクエスト
     */
    public static void invokeDeregisterInstancesFromLoadBalancer(
            NiftyLoadBalancerClient client,
            DeregisterInstancesFromLoadBalancerRequest request) {
        try {
            DeregisterInstancesFromLoadBalancerResult result = client
                    .deregisterInstancesFromLoadBalancer(request);

            out.println("DeregisterInstancesFromLoadBalancer Action Response");
            out.println("=============================================================================");

            if (result.getInstances() != null) {
                List<Instance> instances = result.getInstances();
