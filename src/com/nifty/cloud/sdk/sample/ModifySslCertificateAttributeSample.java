...
import com.nifty.cloud.sdk.sslcert.model.Description;
...
/**
 * ModifySslCertificateAttributeサンプル
 *
 */
public class ModifySslCertificateAttributeSample {

    /**
     * ModifySslCertificateAttributeを実行するサンプルです。
    ...
    public static void main(String[] args) {
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、ModifySslCertificateAttributeを実行します。
         ***********************************************************************/
        ModifySslCertificateAttributeRequest request = new ModifySslCertificateAttributeRequest();
        // request.setFqdnId("fqdnId");
        // Description description = new Description();
        // description.setValue("value");
        // request.setDescription(description);

        invokeModifySslCertificateAttribute(client, request);
    }

    /**
     * ModifySslCertificateAttribute 実行サンプル
     * 設定されたリクエストから ModifySslCertificateAttributeを実行し、実行結果を表示します。
     *
     * @param client   クライアント
     * @param request  リクエスト
     */
    public static void invokeModifySslCertificateAttribute(
            NiftySslCertClient client,
            ModifySslCertificateAttributeRequest request) {
        try {
            ModifySslCertificateAttributeResult result = client.modifySslCertificateAttribute(request);

            out.println("ModifySslCertificateAttribute Action Response");
            out.println("=============================================================================");
