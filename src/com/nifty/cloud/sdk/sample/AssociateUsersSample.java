...
/**
 * AssociateUsersSampleサンプル
 *
 */
public class AssociateUsersSample {

    /**
     * AssociateUsersSampleを実行するサンプルです。
    ...
    public static void main(String[] args) {
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、AssociateUsersを実行します。
         ***********************************************************************/
         AssociateUsersRequest request = new AssociateUsersRequest();
         ...
         invokeAssociateUsers(client, request);
    }

    /**
     * AssociateUsers 実行サンプル
     * 設定されたリクエストから AssociateUsersを実行し、実行結果を表示します。
     *
     * @param client   クライアント
     * @param request  リクエスト
     */
    public static void invokeAssociateUsers(
            NiftyMiscClient client,
            AssociateUsersRequest request) {
        try {
            AssociateUsersResult result = client.associateUsers(request);

            out.println("AssociateUsers Action Response");
            out.println("=============================================================================");
