...
/**
 * DeleteSecurityGroupサンプル
 *
 */
public class DeleteSecurityGroupSample {

    /**
     * DeleteSecurityGroupを実行するサンプルです。
    ...
    public static void main(String[] args) {
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、DeleteSecurityGroupを実行します。
         ***********************************************************************/
        DeleteSecurityGroupRequest request = new DeleteSecurityGroupRequest();
        // request.setGroupName("groupName");

        invokeDeleteSecurityGroup(client, request);
    }

     /**
     * DeleteSecurityGroup 実行サンプル
     * 設定されたリクエストから DeleteSecurityGroup を実行し、実行結果を表示します。
     *
     * @param client   クライアント
     * @param request  リクエスト
     */
    public static void invokeDeleteSecurityGroup(
        ...
        try {
            ...
            out.println("DeleteSecurityGroup Action Response");
            out.println("=============================================================================");
