...
import com.nifty.cloud.sdk.firewall.model.SecurityGroupCourseUpdate;
...
/**
 * UpdateSecurityGroupOptionサンプル
 *
 */
public class UpdateSecurityGroupOptionSample {

    /**
     * UpdateSecurityGroupOptionを実行するサンプルです。
    ...
    public static void main(String[] args) {
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、UpdateSecurityGroupOptionを実行します。
         ***********************************************************************/
        UpdateSecurityGroupOptionRequest request = new UpdateSecurityGroupOptionRequest();
        // SecurityGroupCourseUpdate courseUpdate = new SecurityGroupCourseUpdate();
        // courseUpdate.setCourse("course");
        // courseUpdate.setAgreement(false);
        // request.setCourseUpdate(courseUpdate);
        // request.setSecurityGroupLimitUpdate(0);

        invokeUpdateSecurityGroupOption(client, request);
    }

    /**
     * UpdateSecurityGroupOption 実行サンプル
     * 設定されたリクエストから UpdateSecurityGroupOptionを実行し、実行結果を表示します。
     * 
     * @param client   クライアント
     * @param request  リクエスト
     */
    public static void invokeUpdateSecurityGroupOption(NiftySecurityGroupClient client,
            UpdateSecurityGroupOptionRequest request) {
        try {
            UpdateSecurityGroupOptionResult result = client.updateSecurityGroupOption(request);

            out.println("UpdateSecurityGroupOption Action Response");
            out.println("=============================================================================");
