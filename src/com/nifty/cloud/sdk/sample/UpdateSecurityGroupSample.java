...
/**
 * UpdateSecurityGroupサンプル
 *
 */
public class UpdateSecurityGroupSample {

    /**
     * UpdateSecurityGroupを実行するサンプルです。
    ...
    public static void main(String[] args) {
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、UpdateSecurityGroupを実行します。
         ***********************************************************************/
        UpdateSecurityGroupRequest request = new UpdateSecurityGroupRequest();
        // request.setGroupName("groupName");
        // request.setGroupNameUpdate("groupNameUpdate");
        // request.setGroupDescriptionUpdate("groupDescriptionUpdate");

        invokeUpdateSecurityGroup(client, request);
    }

    /**
     * UpdateSecurityGroup 実行サンプル
     * 設定されたリクエストから UpdateSecurityGroup を実行し、実行結果を表示します。
     *
     * @param client   クライアント
     * @param request  リクエスト
     */
    public static void invokeUpdateSecurityGroup(NiftySecurityGroupClient client,
            UpdateSecurityGroupRequest request) {
        try {
            UpdateSecurityGroupResult result = client.updateSecurityGroup(request);

            out.println("UpdateSecurityGroup Action Response");
            out.println("=============================================================================");
