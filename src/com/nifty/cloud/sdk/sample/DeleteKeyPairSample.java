 ...
 *
 */
public class DeleteKeyPairSample {

    /**
     * DeleteKeyPairを実行するサンプルです。
    ...
    public static void main(String[] args) {
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、DeleteKeyPairを実行します。
         ***********************************************************************/
        DeleteKeyPairRequest request = new DeleteKeyPairRequest();
        // request.setKeyName("keyName");
        invokeDeleteKeyPair(client, request);

    }

    /**
     * DeleteKeyPair 実行サンプル
     * 設定されたリクエストから DeleteKeyPair を実行し、実行結果を表示します。
     *
     * @param client   クライアント
     * @param request  リクエスト
     */
    public static void invokeDeleteKeyPair(NiftySecurityClient client,
            DeleteKeyPairRequest request) {
        try {
            DeleteKeyPairResult result = client.deleteKeyPair(request);

            out.println("DeleteKeyPair Action Response");
            out.println("=============================================================================");
