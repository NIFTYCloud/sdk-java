...
/**
 * DescribeAssociatedUsersサンプル
 *
 */
public class DescribeAssociatedUsersSample {

    /**
     * DescribeAssociatedUsersを実行するサンプルです。
    ...
    public static void main(String[] args) {
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、DescribeAssociatedUsersを実行します。
         ***********************************************************************/
         DescribeAssociatedUsersRequest request = new DescribeAssociatedUsersRequest();
         //request.setFunction("LB");

         invokeDescribeAssociatedUsers(client, request);
    }

    /**
     * AssociateUsers 実行サンプル
     * 設定されたリクエストから DescribeAssociatedUsersを実行し、実行結果を表示します。
     *
     * @param client   クライアント
     * @param request  リクエスト
     */
    public static void invokeDescribeAssociatedUsers(
            NiftyMiscClient client,
            DescribeAssociatedUsersRequest request) {
        try {
            DescribeAssociatedUsersResult result = client.describeAssociatedUsers(request);

            out.println("DescribeAssociatedUsers Action Response");
            out.println("=============================================================================");
