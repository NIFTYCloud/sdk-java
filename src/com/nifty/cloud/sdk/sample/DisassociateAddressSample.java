...
/**
 * DisassociateAddressサンプル
 *
 */
public class DisassociateAddressSample {

    /**
     * DisassociateAddressを実行するサンプルです。
    ...
    public static void main(String[] args) {
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、DisassociateAddressを実行します。
         ***********************************************************************/
         ...
         // request.setNiftyReboot("true");
         // request.setAssociationId("associationId");
        invokeReleaseAddress(client, request);
    }

    /**
     * DisassociateAddress 実行サンプル
     * 設定されたリクエストから DisassociateAddress を実行し、実行結果を表示します。
     *
     * @param client   クライアント
     * @param request  リクエスト
     */
    public static void invokeReleaseAddress(NiftyAddressClient client,
            DisassociateAddressRequest request) {
        try {
            DisassociateAddressResult result = client.disassociateAddress(request);

            out.println("DisassociateAddress Action Response");
            out.println("=============================================================================");
