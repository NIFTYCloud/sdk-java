...
/**
 * ModifyImageAttributeサンプル
 *
 */
public class ModifyImageAttributeSample {

    /**
     * ModifyImageAttributeを実行するサンプルです。
    ...
    public static void main(String[] args) {
         ...
         * 非同期実行を行う場合はNiftyImageAsyncClientクラスを指定します。
         ***********************************************************************/
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、ModifyImageAttributeを実行します。
         ***********************************************************************/
        ...
        invokeModifyImageAttribute(client, request);

    }

    /**
     * ModifyImageAttribute 実行サンプル
     * 設定されたリクエストから ModifyImageAttribute　を実行し、実行結果を表示します。
     *
     * @param client  クライアント
     * @param request リクエスト
     */
    public static void invokeModifyImageAttribute(NiftyImageClient client,
            ModifyImageAttributeRequest request) {
        try {
            ModifyImageAttributeResult result = client.modifyImageAttribute(request);

            out.println("ModifyImageAttribute Action Response");
            out.println("=============================================================================");
