...
/**
 * ModifyVolumeAttributeサンプル
 *
 */
public class ModifyVolumeAttributeSample {

    /**
     * ModifyVolumeAttributeを実行するサンプルです。
    ...
    public static void main(String[] args) {
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、ModifyVolumeAttributeを実行します。
         ***********************************************************************/
        ...
        invokeModifyVolumeAttribute(client, request);
    }

    /**
     * ModifyVolumeAttribute 実行サンプル
     * 設定されたリクエストから ModifyVolumeAttributeを実行し、実行結果を表示します。
     *
     * @param client   クライアント
     * @param request  リクエスト
     */
    public static void invokeModifyVolumeAttribute(
    		NiftyDiskClient client,
            ModifyVolumeAttributeRequest request) {
        try {
            ModifyVolumeAttributeResult result = client.modifyVolumeAttribute(request);

            out.println("ModifyVolumeAttribute Action Response");
            out.println("=============================================================================");
