...
public class RebootInstancesSample {
    ...
    public static void main(String[] args) {
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、RebootInstancesを実行します。
         ***********************************************************************/
        ...
        invokeRebootInstances(client, request);

    }

    /**
     * RebootInstances 実行サンプル
     * 設定されたリクエストから RebootInstances　を実行し、実行結果を表示します。
     *
     * @param client  クライアント
     * @param request リクエスト
     */
    public static void invokeRebootInstances(NiftyServerClient client,
            RebootInstancesRequest request) {
        try {
            RebootInstancesResult result = client.rebootInstances(request);

            out.println("RebootInstances Action Response");
            out.println("=============================================================================");
