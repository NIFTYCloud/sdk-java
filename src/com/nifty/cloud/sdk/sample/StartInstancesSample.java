 ...
 *
 */
public class StartInstancesSample {

    /**
     * StartInstancesを実行するサンプルです。
    ...
    public static void main(String[] args) {
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、StartInstancesを実行します。
         ***********************************************************************/
    ...
    /**
     * StartInstances 実行サンプル
     * 設定されたリクエストから StartInstances を実行し、実行結果を表示します。
     *
     * @param client  クライアント
     * @param request リクエスト
     */
    public static void invokeStartInstances(NiftyServerClient client,
            StartInstancesRequest request) {
        try {
            StartInstancesResult result = client.startInstances(request);
            out.println("StartInstances Action Response");
            out.println("=============================================================================");
            if (result.getStartingInstances() != null) {
                ...
                for (InstanceStateChange startingInstance : startingInstances) {
                    out.println("StartingInstances");
                    if (startingInstance.getInstanceId() != null) {
                        out.println("  InstanceId        : " + startingInstance.getInstanceId());
                    }
                    InstanceState currentState = startingInstance.getCurrentState();
                    ...
                    InstanceState previousState = startingInstance.getPreviousState();
