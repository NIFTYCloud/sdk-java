...
/**
 * UnsetLoadBalancerListenerSSLCertificateサンプル
 *
 */
public class UnsetLoadBalancerListenerSSLCertificateSample {

    /**
     * UnsetLoadBalancerListenerSSLCertificateを実行するサンプルです。
    ...
    public static void main(String[] args) {
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、UnsetLoadBalancerListenerSSLCertificateを実行します。
         ***********************************************************************/
        UnsetLoadBalancerListenerSSLCertificateRequest request = new UnsetLoadBalancerListenerSSLCertificateRequest();
        // request.setLoadBalancerName("loadBalancerName");
        // request.setLoadBalancerPort(0);
        // request.setInstancePort(0);
        invokeUnsetLoadBalancerListenerSSLCertificate(client, request);

    }

    /**
     * UnsetLoadBalancerListenerSSLCertificate 実行サンプル
     * 設定されたリクエストから UnsetLoadBalancerListenerSSLCertificate を実行し、実行結果を表示します。
     *
     * @param client   クライアント
     * @param request  リクエスト
     */
    public static void invokeUnsetLoadBalancerListenerSSLCertificate(NiftyLoadBalancerClient client,
            UnsetLoadBalancerListenerSSLCertificateRequest request) {
        try {
            UnsetLoadBalancerListenerSSLCertificateResult result = client.unsetLoadBalancerListenerSSLCertificate(request);

            out.println("UnsetLoadBalancerListenerSSLCertificate Action Response");
            out.println("=============================================================================");
