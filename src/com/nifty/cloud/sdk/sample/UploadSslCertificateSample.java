...
/**
 * UploadSslCertificateサンプル
 *
 */
public class UploadSslCertificateSample {

    /**
     * UploadSslCertificateを実行するサンプルです。
    ...
    public static void main(String[] args) {
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、UploadSslCertificateを実行します。
         ***********************************************************************/
        UploadSslCertificateRequest request = new UploadSslCertificateRequest();
        // request.setCertificate("certificate");
        // request.setKey("key");
        // request.setCa("ca");

        invokeUploadSslCertificate(client, request);
    }

    /**
     * UploadSslCertificate 実行サンプル
     * 設定されたリクエストから UploadSslCertificateを実行し、実行結果を表示します。
     *
     * @param client   クライアント
     * @param request  リクエスト
     */
    public static void invokeUploadSslCertificate(
            NiftySslCertClient client,
            UploadSslCertificateRequest request) {
        try {
            UploadSslCertificateResult result = client.uploadSslCertificate(request);

            out.println("UploadSslCertificate Action Response");
            out.println("=============================================================================");
            ...
            if (result.getKeyFingerprint() != null) {
                out.println("  KeyFingerprint  : " + result.getKeyFingerprint());
            }
