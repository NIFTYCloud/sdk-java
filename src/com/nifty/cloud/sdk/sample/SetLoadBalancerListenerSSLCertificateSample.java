...
/**
 * SetLoadBalancerListenerSSLCertificateサンプル
 *
 */
public class SetLoadBalancerListenerSSLCertificateSample {

    /**
     * SetLoadBalancerListenerSSLCertificateを実行するサンプルです。
    ...
    public static void main(String[] args) {
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、SetLoadBalancerListenerSSLCertificateを実行します。
         ***********************************************************************/
        ...
        // request.setSslCertificateId("100");
        invokeSetLoadBalancerListenerSSLCertificate(client, request);

    }

    /**
     * SetLoadBalancerListenerSSLCertificate 実行サンプル
     * 設定されたリクエストから SetLoadBalancerListenerSSLCertificate を実行し、実行結果を表示します。
     *
     * @param client   クライアント
     * @param request  リクエスト
     */
    public static void invokeSetLoadBalancerListenerSSLCertificate(NiftyLoadBalancerClient client,
            SetLoadBalancerListenerSSLCertificateRequest request) {
        try {
            SetLoadBalancerListenerSSLCertificateResult result = client.setLoadBalancerListenerSSLCertificate(request);

            out.println("SetLoadBalancerListenerSSLCertificate Action Response");
            out.println("=============================================================================");
