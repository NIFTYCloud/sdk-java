...
public class ReleaseAddressSample {
    ...
    public static void main(String[] args) {
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、ReleaseAddressを実行します。
         ***********************************************************************/
    ...
    /**
     * ReleaseAddress 実行サンプル
     * 設定されたリクエストから ReleaseAddress を実行し、実行結果を表示します。
     *
     * @param client   クライアント
     * @param request  リクエスト
     */
    public static void invokeReleaseAddress(NiftyAddressClient client,
        ...
        try {
            ...
            out.println("ReleaseAddress Action Response");
            out.println("=============================================================================");
