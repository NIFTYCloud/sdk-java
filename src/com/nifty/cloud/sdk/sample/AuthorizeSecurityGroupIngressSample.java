...
/**
 * AuthorizeSecurityGroupIngressサンプル
 *
 */
public class AuthorizeSecurityGroupIngressSample {

    /**
     * AuthorizeSecurityGroupIngressSampleを実行するサンプルです。
    ...
    /**
     * AuthorizeSecurityGroupIngress 実行サンプル
     * 設定されたリクエストから AuthorizeSecurityGroupIngressを実行し、実行結果を表示します。
     *
     * @param client   クライアント
     * @param request  リクエスト
     */
    public static void invokeAuthorizeSecurityGroupIngress(
            NiftySecurityGroupClient client,
            AuthorizeSecurityGroupIngressRequest request) {
        try {
            AuthorizeSecurityGroupIngressResult result = client.authorizeSecurityGroupIngress(request);

            out.println("AuthorizeSecurityGroupIngress Action Response");
            out.println("=============================================================================");
