...
public class CreateSecurityGroupSample {
    ...
    /**
     * CreateSecurityGroupを実行するサンプルです。
    ...
    public static void main(String[] args) {
        ...
        /************************************************************************
         * リクエストパラメーターを設定し、CreateSecurityGroupを実行します。
         ***********************************************************************/
     ...
     /**
     * CreateSecurityGroup 実行サンプル
     * 設定されたリクエストから CreateSecurityGroup を実行し、実行結果を表示します。
     *
     * @param client  クライアント
     * @param request リクエスト
     */
    public static void invokeCreateSecurityGroup(NiftySecurityGroupClient client
            , CreateSecurityGroupRequest request) {
        try {
            CreateSecurityGroupResult result = client.createSecurityGroup(request);

            out.println("CreateSecurityGroup Action Response");
            out.println("=============================================================================");
