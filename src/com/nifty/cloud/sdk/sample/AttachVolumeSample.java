...
public class AttachVolumeSample {
	...
	public static void main(String[] args) {
		...
		/************************************************************************
		 * リクエストパラメーターを設定し、AttachVolumeを実行します。
         ***********************************************************************/
		AttachVolumeRequest request = new AttachVolumeRequest();
		//request.setVolumeId("volumeId");
		//request.setInstanceId("instanceId");
		//request.setDevice("deviceName");
		invokeAttachVolume(client,request);

	}
	
	/**
	 * AttachVolume 実行サンプル
	 * 設定されたリクエストから AttachVolume を実行し、実行結果を表示します。
	 * @param client クライアント
	 * @param request リクエスト
	 */
	public static void invokeAttachVolume(NiftyDiskClient client, AttachVolumeRequest request){
        try {
			AttachVolumeResult result = client.attachVolume(request);
			
			out.println("AttachVolume Action Response");
			out.println("=============================================================================");
