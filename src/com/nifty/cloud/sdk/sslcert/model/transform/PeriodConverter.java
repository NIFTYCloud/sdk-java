...
/**
 * validDateType変換クラス。<br />
 * このクラスはレスポンスXMLのperiod要素からPeriodクラスを生成します。
 *
 */
public class PeriodConverter implements Converter{
    ...
    public boolean canConvert(Class clazz) {
        return clazz == Period.class;
    }

    /**
     * periodをPeriodクラスに変換します。
     *
    ...
    public Object unmarshal(HierarchicalStreamReader reader,
        ...
        while (reader.hasMoreChildren()) {
            ...
            if (name.equals(ELEMENT_START_DATE)) {
                period.setStartDate(DateUtils.toDate(reader.getValue()));
            } else if (name.equals(ELEMENT_END_DATE)) {
                period.setEndDate(DateUtils.toDate(reader.getValue()));
            }
            reader.moveUp();
        }
        return period;
